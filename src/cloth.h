...
struct Cloth {
  ...
  float hash_position(Vector3D pos);
    ...
    std::vector<Spring> getShearing(int x, int y);
    std::vector<Spring> getStructural(int x, int y);
    std::vector<Spring> getBending(int x, int y);
    PointMass* pointAtCoord( int x, int y);
